...
weight: 10
default_lang_commit: dd5997c8b9fafbf72ea6b8059ade242d88b8f118
---
...
CI ジョブはサイト全体の[インストールの動作規約](/site/build/dependencies/#install-contracts)に従って npm の依存関係をインストールします。
ロックファイルに完全一致し、スクリプトを実行しない方式で、ビルドジョブはレビュー済みの Hugo リビルドのみを再有効化します。
